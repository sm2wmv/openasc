/*! \file     rotator/sj2w/bsp.h
 *  \ingroup  rotator_group
 *  \brief    Board support package for the SJ2W rotator controller
 *  \author   Tobias Blomberg, SM0SVX and Mikael Larsmark, SM2WMV
 *  \date     2012-11-30
 *
...
static const int adc_mapping[ROTATOR_COUNT] = {0};
