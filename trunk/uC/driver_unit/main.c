...
void activate_output(unsigned char from_addr, unsigned char index, unsigned char type) {
	...
	switch (index) {
		case 1 :	PORTD |= (1<<DRIVER_OUTPUT_1);
							break;
		case 2 :	PORTD |= (1<<DRIVER_OUTPUT_2);
							break;
		...
		case 12 :	PORTA |= (1<<DRIVER_OUTPUT_12);
							break;
		case 13 :	PORTA |= (1<<DRIVER_OUTPUT_13);
							break;
		case 14 :	PORTA |= (1<<DRIVER_OUTPUT_14);
							break;
		case 15 :	PORTA |= (1<<DRIVER_OUTPUT_15);
							break;
		case 16 :	PORTA |= (1<<DRIVER_OUTPUT_16);
							break;
		case 17 :	PORTB |= (1<<DRIVER_OUTPUT_17);
							break;
		case 18 :	PORTB |= (1<<DRIVER_OUTPUT_18);
							break;
		case 19 :	PORTB |= (1<<DRIVER_OUTPUT_19);
							break;
		case 20 :	PORTB |= (1<<DRIVER_OUTPUT_20);
							break;
		default: 
							break;
	}
