...
#define CREATE_CRITICAL_LIST() static unsigned char critical_cmd_list[] = {BUS_CMD_DRIVER_ACTIVATE_ANT_OUTPUT, BUS_CMD_DRIVER_DEACTIVATE_ANT_OUTPUT, BUS_CMD_DRIVER_ACTIVATE_BAND_OUTPUT, \
