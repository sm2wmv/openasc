...
#define CREATE_CRITICAL_LIST() static unsigned char critical_cmd_list[] = {\
  BUS_CMD_DRIVER_ACTIVATE_ANT_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_ANT_OUTPUT,\
  BUS_CMD_DRIVER_ACTIVATE_BAND_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_BAND_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_ANT_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_BAND_OUTPUTS,\
  BUS_CMD_DRIVER_ACTIVATE_SUBMENU_ANT1_OUTPUT,\
  BUS_CMD_DRIVER_ACTIVATE_SUBMENU_ANT2_OUTPUT,\
  BUS_CMD_DRIVER_ACTIVATE_SUBMENU_ANT4_OUTPUT,\
  BUS_CMD_DRIVER_ACTIVATE_SUBMENU_ANT4_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_SUBMENU_ANT1_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_SUBMENU_ANT2_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_SUBMENU_ANT3_OUTPUT,\
  BUS_CMD_DRIVER_DEACTIVATE_SUBMENU_ANT4_OUTPUT,  \
  BUS_CMD_DRIVER_DEACTIVATE_ALL_SUBMENU_ANT1_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_SUBMENU_ANT2_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_SUBMENU_ANT3_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_SUBMENU_ANT4_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_ALL_TX_ANT_COMB_OUTPUTS,\
  BUS_CMD_DRIVER_DEACTIVATE_TX_ANT_COMBO,\
  BUS_CMD_DRIVER_ACTIVATE_TX_ANT_COMBO,\
  BUS_CMD_DRIVER_DEACTIVATE_RX_ANT_COMBO,\
  BUS_CMD_DRIVER_ACTIVATE_RX_ANT_COMBO\  
};

/*! This defines the number of main boxes on the bus, this is used in the ping list to handle
 *  the band check data information */
#define MAINBOX_DEVICE_COUNT 6
