...
/*! Calibration parameters */
	...
	#define PICKUP_SCALE_FWD_VALUE_160M 13.12
	#define	PICKUP_SCALE_FWD_VALUE_80M  12.9
	#define	PICKUP_SCALE_FWD_VALUE_40M  13.11
	#define	PICKUP_SCALE_FWD_VALUE_20M 	13.11
	#define	PICKUP_SCALE_FWD_VALUE_15M 	13.49
	#define	PICKUP_SCALE_FWD_VALUE_10M 	13.2

	#define PICKUP_SCALE_FWD_CONSTANT_160M	-3.16
	#define PICKUP_SCALE_FWD_CONSTANT_80M	  -2.57
	#define PICKUP_SCALE_FWD_CONSTANT_40M		-3.56
	#define PICKUP_SCALE_FWD_CONSTANT_20M		-3.69
	#define PICKUP_SCALE_FWD_CONSTANT_15M		-5.47
	#define PICKUP_SCALE_FWD_CONSTANT_10M		-5.11

	#define PICKUP_SCALE_REF_VALUE_160M 13.62
	#define	PICKUP_SCALE_REF_VALUE_80M  13.83
	#define	PICKUP_SCALE_REF_VALUE_40M  13.33
	#define	PICKUP_SCALE_REF_VALUE_20M 	13.44
	#define	PICKUP_SCALE_REF_VALUE_15M 	13.3
	#define	PICKUP_SCALE_REF_VALUE_10M 	12.87

	#define PICKUP_SCALE_REF_CONSTANT_160M	21.71
	#define PICKUP_SCALE_REF_CONSTANT_80M		20.73
	#define PICKUP_SCALE_REF_CONSTANT_40M		20.06
	#define PICKUP_SCALE_REF_CONSTANT_20M		17.15
	#define PICKUP_SCALE_REF_CONSTANT_15M		16.69
	#define PICKUP_SCALE_REF_CONSTANT_10M		18.59
		
	//How many mV that we have while having no input on the power meter
	#define PICKUP_FWD_0DBM_CONST_VOLTAGE 350
	#define PICKUP_REF_0DBM_CONST_VOLTAGE 275
#endif
