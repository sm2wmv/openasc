...
/*! Calibration parameters */
	...
	#define PICKUP_SCALE_FWD_VALUE_160M 13.19
	#define	PICKUP_SCALE_FWD_VALUE_80M  13.19
	#define	PICKUP_SCALE_FWD_VALUE_40M  13.17
	#define	PICKUP_SCALE_FWD_VALUE_20M 	13.12
	#define	PICKUP_SCALE_FWD_VALUE_15M 	12.91
	#define	PICKUP_SCALE_FWD_VALUE_10M 	12.86

	#define PICKUP_SCALE_FWD_CONSTANT_160M	-3.61
	#define PICKUP_SCALE_FWD_CONSTANT_80M	  -3.71
	#define PICKUP_SCALE_FWD_CONSTANT_40M		-3.93
	#define PICKUP_SCALE_FWD_CONSTANT_20M		-3.95
	#define PICKUP_SCALE_FWD_CONSTANT_15M		-3.73
	#define PICKUP_SCALE_FWD_CONSTANT_10M		-4.45

	#define PICKUP_SCALE_REF_VALUE_160M 13.35
	#define	PICKUP_SCALE_REF_VALUE_80M  13.34
	#define	PICKUP_SCALE_REF_VALUE_40M  13.31
	#define	PICKUP_SCALE_REF_VALUE_20M 	13.27
	#define	PICKUP_SCALE_REF_VALUE_15M 	13.25
	#define	PICKUP_SCALE_REF_VALUE_10M 	13.06

	#define PICKUP_SCALE_REF_CONSTANT_160M	4.47
	#define PICKUP_SCALE_REF_CONSTANT_80M		4.35
	#define PICKUP_SCALE_REF_CONSTANT_40M		4.21
	#define PICKUP_SCALE_REF_CONSTANT_20M		4.17
	#define PICKUP_SCALE_REF_CONSTANT_15M		3.87
	#define PICKUP_SCALE_REF_CONSTANT_10M		3.81
