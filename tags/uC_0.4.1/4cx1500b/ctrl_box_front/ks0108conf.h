/*! \file 4cx1500b/ctrl_box_front/ks0108conf.h 
...
// GLCD_PORT_INTERFACE specifics
	...
	// make sure these parameters are not already defined elsewhere
		...
		#define GLCD_CTRL_PORT 	PORTK	// PORT for LCD control signals
		#define GLCD_CTRL_DDR		DDRK	// DDR register of LCD_CTRL_PORT
		#define GLCD_CTRL_RS		PK4		// pin for LCD Register Select
		#define GLCD_CTRL_RW		PK3		// pin for LCD Read/Write
		#define GLCD_CTRL_E			PK5		// pin for LCD Enable
		#define GLCD_CTRL_CS0		PK1		// pin for LCD Controller 0 Chip Select
		#define GLCD_CTRL_CS1		PK0		// pin for LCD Controller 1 Chip Select(*)
		#define GLCD_CTRL_CS2		PA1		// pin for LCD Controller 2 Chip Select(*)
		#define GLCD_CTRL_CS3		PA0		// pin for LCD Controller 3 Chip Select(*)
		#define GLCD_CTRL_RESET	PK2		// pin for LCD Reset
